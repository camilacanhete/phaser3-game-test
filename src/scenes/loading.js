...
import shoot from '../assets/audio/shootBall.mp3';
...
export class Loading extends Scene {    
    ...
    loadAssets() {        
        ...
        this.load.audio(Const.AUDIO.SHOOT, shoot);
        this.load.audio(Const.AUDIO.SPLASH, splash);
        this.load.audio(Const.AUDIO.SWIPE, swipe);
        this.load.audio(Const.AUDIO.WRONG, wrong);
